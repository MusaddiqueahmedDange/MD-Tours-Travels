...
import CruiseBanner from "./CruiseImages/CruiseBanner.png";

// Assuming this path to your data file
import Cruise from "./cruiseData";
import "./cruise.css";
...
const HeroBanner = () => {
  ...
  return (
    <div className="hero-banner-container">
      <img
        src={CruiseBanner}
        alt="Cruise Destinations Banner - World Landmarks"
      ...
      <div className="hero-content-overlay">
        <h1 className="hero-title">Cruise Destinations</h1>
